...
if($_POST["paquete1"] > 0){
    ...
    if($duplicados == 0){
        $statement = "INSERT INTO usuarios_paquetes (idUsuario,paquete) VALUES ($idUsuario, 1, $lugares)";
...
if($_POST["paquete2"] > 0){
    ...
    if($duplicados == 0){
        $statement = "INSERT INTO usuarios_paquetes (idUsuario,paquete) VALUES ($idUsuario, 2, $lugares)";
        $resultado = $conexionBD->query($statement);
...
if($_POST["paquete3"] > 0){
    ...
    if($duplicados == 0){
        $statement = "INSERT INTO usuarios_paquetes (idUsuario,paquete) VALUES ($idUsuario, 3, $lugares)";
        $resultado = $conexionBD->query($statement);
